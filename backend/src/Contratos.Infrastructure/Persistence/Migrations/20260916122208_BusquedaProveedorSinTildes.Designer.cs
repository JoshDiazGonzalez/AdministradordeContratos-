...
namespace Contratos.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260916122208_BusquedaProveedorSinTildes")]
    partial class BusquedaProveedorSinTildes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Contratos.Domain.Entities.Contrato", b =>
                {
                    ...
                    b.Property<string>("NombreProveedorBusqueda")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("nombre_proveedor_busqueda");
                    ...
                    b.HasIndex("NombreProveedorBusqueda")
